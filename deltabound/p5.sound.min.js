...
! function(t, e) {
  ...
  master = function() {
    ...
    }, p5.prototype.masterVolume = function(t, i, n) {
      if ("number" == typeof t) {
        var i = i || 0,
          n = n || 0,
          o = e.audiocontext.currentTime,
          r = e.output.gain.value;
        e.output.gain.cancelScheduledValues(o + n), e.output.gain.linearRampToValueAtTime(r, o + n), e.output.gain.linearRampToValueAtTime(t, o + n + i)
      } else {
  ...
  helpers = function() {
    var t = master;
    return p5.prototype.sampleRate = function() {
      ...
      if ("string" == typeof e) {
        ...
        if (["mp3", "wav", "ogg", "m4a", "aac"].indexOf(n) > -1)
          if (p5.prototype.isFileSupported(n)) i = i;
          else
            for (var o = i.split("."), r = o[o.length - 1], s = 0; s < t.extensions.length; s++) {
              var a = t.extensions[s],
                u = p5.prototype.isFileSupported(a);
              if (u) {
                r = "", 2 === o.length && (r += o[0]);
                for (var s = 1; s <= o.length - 2; s++) {
                  var p = o[s];
                  r += "." + p
                }
                i = r += ".", i = i += a;
      ...
      return i
    }, p5.prototype._mathChain = function(t, e, i, n, o) {
  ...
  panner = function() {
    var t = master,
      e = t.audiocontext;
    "undefined" != typeof e.createStereoPanner ? (p5.Panner = function(t, i) {
      ...
      return n.panningModel = "HRTF", n.distanceModel = "linear", n.setPosition(0, 0, 0), t.connect(n), n.connect(i), n.pan = function(t, e, i) {
        n.setPosition(t, e, i)
      }, n
    }
  }(master);
  ...
  soundfile = function() {
        ...
        for (var o = 0; 10 > o; o++) {
          ...
          if (r && s) {
            var a = r.sampleIndex,
              u = s.sampleIndex,
              p = u - a;
            p > 0 && r.intervals.push(p);
            var c = e.some(function(t) {
              return t.interval === p ? (t.count++, t) : void 0
            });
            c || e.push({
              interval: p,
              count: 1
    ...
    function n(t, e, i, n) {
      for (var r = [], s = Object.keys(t).sort(), a = 0; a < s.length; a++)
        for (var u = s[a], p = t[u], c = 0; c < p.intervals.length; c++) {
          var h = Math.round(Math.abs(60 / (p.intervals[c] / i)));
          h = o(h), Math.abs(h - e) < n && r.push(p.sampleIndex / 44100)
        }
    ...
    var r = errorHandler,
      s = master,
      a = s.audiocontext,
      u = helpers.midiToFreq;
    p5.SoundFile = function(t, e, i, n) {
      ...
      var o = this,
        r = new p5.SoundFile(t, function() {
          "function" == typeof e && e.apply(o, arguments), o._decrementPreload()
        }, i, n);
      return r
      ...
      if (void 0 !== this.url && "" !== this.url) {
        ...
        o.addEventListener("progress", function(t) {
          ...
          if (200 === o.status) a.decodeAudioData(o.response, function(e) {
            i.buffer = e, i.panner.inputChannels(e.numberOfChannels), t && t(i)
          }, function() {
            var t = new r("decodeAudioData", n, i.url),
              o = "AudioContext error at decodeAudioData for " + i.url;
            e ? (t.msg = o, e(t)) : console.error(o + "\n The error stack trace includes: \n" + t.stack)
          });
          else {
            var s = new r("loadSound", n, i.url),
              u = "Unable to load " + i.url + ". The request status was: " + o.status + " (" + o.statusText + ")";
            e ? (s.message = u, e(s)) : console.error(u + "\n The error stack trace includes: \n" + s.stack)
          }
        }, o.onerror = function() {
          var t = new r("loadSound", n, i.url),
    ...
    }, p5.SoundFile.prototype.play = function(t, e, i, n, o) {
      var r, a, u = this,
        p = s.audiocontext.currentTime,
        c = t || 0;
      if (0 > c && (c = 0), c += p, this.rate(e), this.setVolume(i), !this.buffer) throw "not ready to play file, buffer has yet to load. Try preload()";
      if (this._pauseTime = 0, "restart" === this.mode && this.buffer && this.bufferSourceNode && (this.bufferSourceNode.stop(c), this._counterNode.stop(c)), this.bufferSourceNode = this._initSourceNode(), this._counterNode && (this._counterNode = void 0), this._counterNode = this._initCounterNode(), n) {
        if (!(n >= 0 && n < this.buffer.duration)) throw "start time out of range";
        r = n
      } else r = 0;
      o = o ? o <= this.buffer.duration - r ? o : this.buffer.duration : this.buffer.duration - r, this.bufferSourceNode.connect(this.output), this._paused ? (this.bufferSourceNode.start(c, this.pauseTime, o), this._counterNode.start(c, this.pauseTime, o)) : (this.bufferSourceNode.start(c, r, o), this._counterNode.start(c, r, o)), this._playing = !0, this._paused = !1, this.bufferSourceNodes.push(this.bufferSourceNode), this.bufferSourceNode._arrayIndex = this.bufferSourceNodes.length - 1;
      var h = function() {
      ...
      this.bufferSourceNode.onended = h, this.bufferSourceNode.loop = this._looping, this._counterNode.loop = this._looping, this._looping === !0 && (a = r + o, this.bufferSourceNode.loopStart = r, this.bufferSourceNode.loopEnd = a, this._counterNode.loopStart = r, this._counterNode.loopEnd = a)
    ...
    }, p5.SoundFile.prototype.loop = function(t, e, i, n, o) {
      ...
      if ("number" == typeof t) {
        var n = e || 0,
          o = i || 0,
          r = s.audiocontext.currentTime,
          a = this.output.gain.value;
        this.output.gain.cancelScheduledValues(r + o), this.output.gain.linearRampToValueAtTime(a, r + o), this.output.gain.linearRampToValueAtTime(t, r + o + n)
      } else {
      ...
      if (0 === t) t = 1e-13;
      else if (0 > t && !this.reversed) {
        var e = this.currentTime(),
          i = (e - this.duration()) / t;
        this.pauseTime = i, this.reverseBuffer(), t = Math.abs(t)
      } else t > 0 && this.reversed && this.reverseBuffer();
      ...
      return this.playbackRate = t, this.playbackRate
      ...
      this.isPlaying() && this.stop(), this.play(0, this.playbackRate, this.output.gain.value, i, n)
      ...
      if (t || (t = 5 * window.width), this.buffer) {
        for (var e = this.buffer, i = e.length / t, n = ~~(i / 10) || 1, o = e.numberOfChannels, r = new Float32Array(Math.round(t)), s = 0; o > s; s++)
          for (var a = e.getChannelData(s), u = 0; t > u; u++) {
            for (var p = ~~(u * i), c = ~~(p + i), h = 0, l = p; c > l; l += n) {
              var f = a[l];
              f > h ? h = f : -f > h && (h = f)
      ...
      if (this.setVolume(0, .01, 0), !this.buffer) throw "SoundFile is not done loading";
      for (var e = 0; e < this.buffer.numberOfChannels; e++) Array.prototype.reverse.call(this.buffer.getChannelData(e));
      this.reversed = !this.reversed, this.setVolume(t, .01, .0101)
      ...
      var e = t.length,
        i = t[0].length,
        n = a.createBuffer(e, i, a.sampleRate);
    ...
    var p = function(t) {
      for (var e = new Float32Array(t.length), i = a.createBuffer(1, t.length, 44100), n = 0; n < t.length; n++) e[n] = n;
    ...
    p5.SoundFile.prototype._initCounterNode = function() {
      ...
      return t._scopeNode && (t._scopeNode.disconnect(), t._scopeNode.onaudioprocess = void 0, t._scopeNode = null), t._scopeNode = a.createScriptProcessor(256, 1, 1), i.buffer = p(t.buffer), i.playbackRate.setValueAtTime(t.playbackRate, e), i.connect(t._scopeNode), t._scopeNode.connect(p5.soundOut._silentNode), t._scopeNode.onaudioprocess = function(e) {
      ...
      return t.buffer = this.buffer, t.playbackRate.value = this.playbackRate, t
    }, p5.SoundFile.prototype.processPeaks = function(o, r, s, a) {
      var u = this.buffer.length,
        ...
        d = s || .22,
        m = a || 200,
        y = new window.OfflineAudioContext(1, u, p),
        _ = y.createBufferSource();
      _.buffer = c;
      var g = y.createBiquadFilter();
      g.type = "lowpass", _.connect(g), g.connect(y.destination), _.start(0), y.startRendering(), y.oncomplete = function(r) {
        var s = r.renderedBuffer,
          a = s.getChannelData(0);
        do h = t(a, f), f -= .005; while (Object.keys(h).length < m && f >= d);
        var u = e(h),
          p = i(u, s.sampleRate),
          c = p.sort(function(t, e) {
            return e.count - t.count
          }).splice(0, 5);
        this.tempo = c[0].tempo;
        var l = 5,
          y = n(h, c[0].tempo, s.sampleRate, l);
        o(y)
      }
    };
    var c = function(t, e) {
  ...
  amplitude = function() {
    ...
    p5.Amplitude = function(e) {
      ...
      for (var e = 0; e < t.inputBuffer.numberOfChannels; e++) {
        ...
        var u = r / o,
          p = Math.sqrt(s / o);
        this.stereoVol[e] = Math.max(p, this.stereoVol[e] * this.smoothing), this.stereoAvg[e] = Math.max(u, this.stereoVol[e] * this.smoothing), this.volMax = Math.max(this.stereoVol[e], this.volMax)
      }
      var c = this,
        h = this.stereoVol.reduce(function(t, e, i) {
          return c.stereoVolNorm[i - 1] = Math.max(Math.min(c.stereoVol[i - 1] / c.volMax, 1), 0), c.stereoVolNorm[i] = Math.max(Math.min(c.stereoVol[i] / c.volMax, 1), 0), t + e
        });
  ...
  fft = function() {
    var t = master;
    p5.FFT = function(e, i) {
      this.input = this.analyser = t.audiocontext.createAnalyser(), Object.defineProperties(this, {
        bins: {
          get: function() {
      ...
      if (e && !p5.prototype._isSafari()) return n(this, this.timeDomain), this.analyser.getFloatTimeDomainData(this.timeDomain), this.timeDomain;
      o(this, this.timeDomain), this.analyser.getByteTimeDomainData(this.timeDomain);
      for (var i = new Array, s = 0; s < this.timeDomain.length; s++) {
        var a = p5.prototype.map(this.timeDomain[s], 0, 255, -1, 1);
        i.push(a)
      }
      return i
    }, p5.FFT.prototype.analyze = function() {
      for (var t, n = 0; n < arguments.length; n++) "number" == typeof arguments[n] && (this.bins = arguments[n], this.analyser.fftSize = 2 * this.bins), "string" == typeof arguments[n] && (t = arguments[n]);
      if (t && "db" === t.toLowerCase()) return e(this), this.analyser.getFloatFrequencyData(this.freqDomain), this.freqDomain;
      ...
      if (i) {
        if (e && i) {
          ...
          for (var r = Math.round(e / n * this.freqDomain.length), s = Math.round(i / n * this.freqDomain.length), a = 0, u = 0, p = r; s >= p; p++) a += this.freqDomain[p], u += 1;
          var c = a / u;
          return c
        }
        throw "invalid input for getEnergy()"
      }
      var h = Math.round(e / n * this.freqDomain.length);
      ...
      for (var e = t.audiocontext.sampleRate / 2, i = 0, n = 0, o = 0; o < this.freqDomain.length; o++) i += o * this.freqDomain[o], n += this.freqDomain[o];
      var r = 0;
      0 !== n && (r = i / n);
      ...
      return o
    }, p5.FFT.prototype.logAverages = function(e) {
      for (var i = t.audiocontext.sampleRate / 2, n = this.freqDomain, o = n.length, r = new Array(e.length), s = 0, a = 0; o > a; a++) {
        var u = Math.round(a * i / this.freqDomain.length);
        u > e[s].hi && s++, r[s] = void 0 !== r[s] ? (r[s] + n[a]) / 2 : n[a]
      }
      return r
    }, p5.FFT.prototype.getOctaveBands = function(e, i) {
      var e = e || 3,
        i = i || 15.625,
        n = [],
        o = {
          lo: i / Math.pow(2, 1 / (2 * e)),
          ctr: i,
          hi: i * Math.pow(2, 1 / (2 * e))
        };
      n.push(o);
      for (var r = t.audiocontext.sampleRate / 2; o.hi < r;) {
        var s = {};
        s.lo = o.hi, s.ctr = o.ctr * Math.pow(2, 1 / e), s.hi = s.ctr * Math.pow(2, 1 / (2 * e)), n.push(s), o = s
      }
      return n
    };
    var e = function(t) {
  ...
  Tone_core_Tone = function() {
    ...
    i = new AudioContext, e(AudioContext.prototype.createGain) || (AudioContext.prototype.createGain = AudioContext.prototype.createGainNode), e(AudioContext.prototype.createDelay) || (AudioContext.prototype.createDelay = AudioContext.prototype.createDelayNode), e(AudioContext.prototype.createPeriodicWave) || (AudioContext.prototype.createPeriodicWave = AudioContext.prototype.createWaveTable), e(AudioBufferSourceNode.prototype.start) || (AudioBufferSourceNode.prototype.start = AudioBufferSourceNode.prototype.noteGrainOn),
      e(AudioBufferSourceNode.prototype.stop) || (AudioBufferSourceNode.prototype.stop = AudioBufferSourceNode.prototype.noteOff), e(OscillatorNode.prototype.start) || (OscillatorNode.prototype.start = OscillatorNode.prototype.noteOn), e(OscillatorNode.prototype.stop) || (OscillatorNode.prototype.stop = OscillatorNode.prototype.noteOff), e(OscillatorNode.prototype.setPeriodicWave) || (OscillatorNode.prototype.setPeriodicWave = OscillatorNode.prototype.setWaveTable), AudioNode.prototype._nativeConnect = AudioNode.prototype.connect, AudioNode.prototype.connect = function(e, i, n) {
        if (e.input) Array.isArray(e.input) ? (t(n) && (n = 0), this.connect(e.input[n])) : this.connect(e.input, i, n);
        else try {
          e instanceof AudioNode ? this._nativeConnect(e, i, n) : this._nativeConnect(e, i)
        } catch (o) {
    ...
    n.prototype.set = function(e, i, o) {
      if (this.isObject(e)) o = i;
      ...
      for (var s in e) {
        ...
        var a = this;
        if (-1 !== s.indexOf(".")) {
          for (var u = s.split("."), p = 0; p < u.length - 1; p++) a = a[u[p]];
          s = u[u.length - 1]
        }
        var c = a[s];
        t(c) || (n.Signal && c instanceof n.Signal || n.Param && c instanceof n.Param ? c.value !== i && (t(o) ? c.value = i : c.rampTo(i, o)) : c instanceof AudioParam ? c.value !== i && (c.value = i) : c instanceof n ? c.set(i) : c !== i && (a[s] = i))
      }
      return this
      ...
      for (var o = {}, r = 0; r < i.length; r++) {
        var s = i[r],
          ...
          u = o;
        if (-1 !== s.indexOf(".")) {
          for (var p = s.split("."), c = 0; c < p.length - 1; c++) {
            var h = p[c];
            u[h] = u[h] || {}, u = u[h], a = a[h]
          }
          s = p[p.length - 1]
        ...
        var l = a[s];
        this.isObject(i[s]) ? u[s] = l.get() : n.Signal && l instanceof n.Signal ? u[s] = l.value : n.Param && l instanceof n.Param ? u[s] = l.value : l instanceof AudioParam ? u[s] = l.value : l instanceof n ? u[s] = l.get() : e(l) || t(l) || (u[s] = l)
      }
      return o
      ...
      for (var t in n) {
        var i = t[0].match(/^[A-Z]$/),
          o = n[t] === this.constructor;
        if (e(n[t]) && i && o) return t
      }
      return "Tone"
    }, n.context = i, n.prototype.context = n.context, n.prototype.bufferSize = 2048, n.prototype.blockTime = 128 / n.context.sampleRate, n.prototype.dispose = function() {
    ...
    n.prototype.noGC = function() {
      return this.output.connect(o), this
    }, AudioNode.prototype.noGC = function() {
      return this.connect(o), this
    }, n.prototype.connect = function(t, e, i) {
      ...
      return this
    }, AudioNode.prototype.chain = n.prototype.chain, AudioNode.prototype.fan = n.prototype.fan, n.prototype.defaultArg = function(e, i) {
      if (this.isObject(e) && this.isObject(i)) {
        var n = {};
        for (var o in e) n[o] = this.defaultArg(i[o], e[o]);
        for (var r in i) n[r] = this.defaultArg(e[r], i[r]);
        return n
      }
      return t(e) ? i : e
    }, n.prototype.optionsObject = function(t, e, i) {
      var n = {};
      if (1 === t.length && this.isObject(t[0])) n = t[0];
      else
        for (var o = 0; o < e.length; o++) n[e[o]] = t[o];
      return this.isUndef(i) ? n : this.defaultArg(n, i)
    }, n.prototype.isUndef = t, n.prototype.isFunction = e, n.prototype.isNumber = function(t) {
    ...
    }, n.extend = function(e, i) {
      function o() {}
      t(i) && (i = n), o.prototype = i.prototype, e.prototype = new o, e.prototype.constructor = e, e._super = i
    };
    var r = [];
    return n._initAudioContext = function(t) {
      t(n.context), r.push(t)
    }, n.setContext = function(t) {
      n.prototype.context = t, n.context = t;
      for (var e = 0; e < r.length; e++) r[e](t)
    }, n.startMobile = function() {
      var t = n.context.createOscillator(),
        e = n.context.createGain();
      e.gain.value = 0, t.connect(e), e.connect(n.context.destination);
      var i = n.context.currentTime;
      t.start(i), t.stop(i + 1)
    }, n._initAudioContext(function(t) {
      n.prototype.blockTime = 128 / t.sampleRate, o = t.createGain(), o.gain.value = 0, o.connect(t.destination)
    }), n.version = "r7-dev", n
  }();
  ...
  Tone_core_Type = function(Tone) {
    ...
    function toNotationHelper(t, e, i, n) {
      for (var o = this.toSeconds(t), r = this.notationToSeconds(n[n.length - 1], e, i), s = "", a = 0; a < n.length; a++) {
        var u = this.notationToSeconds(n[a], e, i),
          p = o / u,
          c = 1e-6;
        if (c > 1 - p % 1 && (p += c), p = Math.floor(p), p > 0) {
          if (s += 1 === p ? n[a] : p.toString() + "*" + n[a], o -= p * u, r > o) break;
          s += " + "
        }
      }
      return "" === s && (s = "0"), s
    ...
    Tone.Type = {
      ...
      0 === o && (r = 0);
      var s = t.slice(-1);
      return r = "t" === s ? 4 / o * 2 / 3 : "n" === s ? 4 / o : "m" === s ? o * i : 0, n * r
      ...
      var n = 0,
        ...
        r = 0,
        s = t.split(":");
      2 === s.length ? (n = parseFloat(s[0]), o = parseFloat(s[1])) : 1 === s.length ? o = parseFloat(s[0]) : 3 === s.length && (n = parseFloat(s[0]), o = parseFloat(s[1]), r = parseFloat(s[2]));
      var a = n * i + o + r / 4;
      return a * (60 / e)
      ...
      return this.secondsToTransportTime(n, e, i)
  ...
  Tone_core_Param = function(t) {
    ...
    return t.Param = function() {
      ...
      var i = this.now(),
        n = this.value;
      return this.setValueAtTime(Math.max(n, this._minOutput), i), this.exponentialRampToValueAtTime(t, i + this.toSeconds(e)), this
  ...
  Tone_signal_Signal = function(t) {
    ...
    return t.Signal = function() {
      ...
      for (var i = e.createBuffer(1, 128, e.sampleRate), n = i.getChannelData(0), o = 0; o < n.length; o++) n[o] = 1;
  ...
  signal = function() {
    var t = Tone_signal_Signal,
      ...
      o = Tone_core_Tone,
      r = master;
    o.setContext(r.audiocontext), p5.Signal = function(e) {
      var i = new t(e);
      return i
    }, t.prototype.fade = t.prototype.linearRampToValueAtTime, i.prototype.fade = t.prototype.fade, e.prototype.fade = t.prototype.fade, n.prototype.fade = t.prototype.fade, t.prototype.setInput = function(t) {
      t.connect(this)
    }, i.prototype.setInput = t.prototype.setInput, e.prototype.setInput = t.prototype.setInput, n.prototype.setInput = t.prototype.setInput, t.prototype.add = function(t) {
      var i = new e(t);
      return this.connect(i), i
    }, i.prototype.add = t.prototype.add, e.prototype.add = t.prototype.add, n.prototype.add = t.prototype.add, t.prototype.mult = function(t) {
      var e = new i(t);
      return this.connect(e), e
    }, i.prototype.mult = t.prototype.mult, e.prototype.mult = t.prototype.mult, n.prototype.mult = t.prototype.mult, t.prototype.scale = function(t, e, i, o) {
      var r, s;
      4 === arguments.length ? (r = p5.prototype.map(i, t, e, 0, 1) - .5, s = p5.prototype.map(o, t, e, 0, 1) - .5) : (r = arguments[0], s = arguments[1]);
      var a = new n(r, s);
      return this.connect(a), a
    }, i.prototype.scale = t.prototype.scale, e.prototype.scale = t.prototype.scale, n.prototype.scale = t.prototype.scale
  ...
  oscillator = function() {
    ...
    p5.Oscillator = function(e, i) {
      ...
      this.started = !1, this.phaseAmount = void 0, this.oscillator = t.audiocontext.createOscillator(), this.f = e || 440, this.oscillator.type = i || "sine", this.oscillator.frequency.setValueAtTime(this.f, t.audiocontext.currentTime), this.output = t.audiocontext.createGain(), this._freqMods = [], this.output.gain.value = .5, this.output.gain.setValueAtTime(.5, t.audiocontext.currentTime), this.oscillator.connect(this.output), this.panPosition = 0, this.connection = t.input, this.panner = new p5.Panner(this.output, this.connection, 1), this.mathOps = [this.output], t.soundArray.push(this)
      ...
      if (!this.started) {
        ...
        this.oscillator && (this.oscillator.disconnect(), this.oscillator = void 0), this.oscillator = t.audiocontext.createOscillator(), this.oscillator.frequency.value = Math.abs(o), this.oscillator.type = r, this.oscillator.connect(this.output), e = e || 0, this.oscillator.start(e + t.audiocontext.currentTime), this.freqNode = this.oscillator.frequency;
    ...
    }, p5.Oscillator.prototype.amp = function(e, i, n) {
      var o = this;
      if ("number" == typeof e) {
        var i = i || 0,
          n = n || 0,
          r = t.audiocontext.currentTime;
        this.output.gain.linearRampToValueAtTime(e, r + n + i)
      } else {
        if (!e) return this.output.gain;
        e.connect(o.output.gain)
      }
    }, p5.Oscillator.prototype.fade = p5.Oscillator.prototype.amp, p5.Oscillator.prototype.getAmp = function() {
      return this.output.gain.value
    }, p5.Oscillator.prototype.freq = function(e, i, n) {
      if ("number" != typeof e || isNaN(e)) {
        ...
        var o = t.audiocontext.currentTime,
          i = i || 0,
          n = n || 0;
        0 === i ? (this.oscillator.frequency.cancelScheduledValues(o), this.oscillator.frequency.setValueAtTime(e, n + o)) : e > 0 ? this.oscillator.frequency.exponentialRampToValueAtTime(e, n + i + o) : this.oscillator.frequency.linearRampToValueAtTime(e, n + i + o), this.phaseAmount && this.phase(this.phaseAmount)
      }
      ...
      var i = p5.prototype.map(e, 0, 1, 0, 1 / this.f),
        n = t.audiocontext.currentTime;
      this.phaseAmount = e, this.dNode || (this.dNode = t.audiocontext.createDelay(), this.oscillator.disconnect(), this.oscillator.connect(this.dNode), this.dNode.connect(this.output)), this.dNode.delayTime.setValueAtTime(i, n)
    };
    ...
    p5.Oscillator.prototype.add = function(t) {
      var i = new e(t),
        ...
        r = this.output;
      return o(this, i, n, r, e)
    }, p5.Oscillator.prototype.mult = function(t) {
      var e = new i(t),
        n = this.mathOps.length - 1,
        r = this.output;
      return o(this, e, n, r, i)
  ...
  Tone_core_Timeline = function(t) {
    ...
    return t.Timeline = function() {
      ...
      for (var e = 0, i = this._timeline.length, n = i; n >= e && i > e;) {
        var o = Math.floor(e + (n - e) / 2),
          r = this._timeline[o];
        if (r.time === t) {
          for (var s = o; s < this._timeline.length; s++) {
            var a = this._timeline[s];
            a.time === t && (o = s)
          }
          return o
        }
        r.time > t ? n = o - 1 : r.time < t && (e = o + 1)
      }
      return e - 1
  ...
  Tone_signal_TimelineSignal = function(t) {
    ...
    return t.TimelineSignal = function() {
      ...
      return e = this._fromUnits(e), e = Math.max(this._minOutput, e), n = Math.max(this._minOutput, n), i = this.toSeconds(i), this._events.addEvent({
      ...
      return n && (this.cancelScheduledValues(e), n.type === t.TimelineSignal.Type.Linear ? this.linearRampToValueAtTime(i, e) : n.type === t.TimelineSignal.Type.Exponential && this.exponentialRampToValueAtTime(i, e)), this.setValueAtTime(i, e), this
      ...
      if (null === n) o = this._initial;
        ...
        var r, s = this._events.getEventBefore(n.time);
        r = null === s ? this._initial : s.value, o = this._exponentialApproach(n.time, r, n.value, n.constant, e)
      } else o = null === i ? n.value : i.type === t.TimelineSignal.Type.Linear ? this._linearInterpolate(n.time, n.value, i.time, i.value, e) : i.type === t.TimelineSignal.Type.Exponential ? this._exponentialInterpolate(n.time, n.value, i.time, i.value, e) : n.value;
      return o
  ...
  env = function() {
    var t = master,
      ...
      i = Tone_signal_Multiply,
      n = Tone_signal_Scale,
      o = Tone_signal_TimelineSignal,
      r = Tone_core_Tone;
    r.setContext(t.audiocontext), p5.Env = function(e, i, n, r, s, a) {
      this.aTime = e || .1, this.aLevel = i || 1, this.dTime = n || .5, this.dLevel = r || 0, this.rTime = s || 0, this.rLevel = a || 0, this._rampHighPercentage = .98, this._rampLowPercentage = .02, this.output = t.audiocontext.createGain(), this.control = new o, this._init(), this.control.connect(this.output), this.connection = null, this.mathOps = [this.control], this.isExponential = !1, this.sourceToClear = null, this.wasTriggered = !1, t.soundArray.push(this)
      ...
      return 0 >= t && (t = 1e-8), t
    }, p5.Env.prototype.play = function(t, e, i) {
      var n = e || 0,
        i = i || 0;
    ...
    }, p5.Env.prototype.ramp = function(e, i, n, o) {
      var r = t.audiocontext.currentTime,
        s = i || 0,
        a = r + s,
        u = this.checkExpInput(n),
        p = "undefined" != typeof o ? this.checkExpInput(o) : void 0;
      e && this.connection !== e && this.connect(e);
      var c = this.checkExpInput(this.control.getValueAtTime(a));
      ...
      var i = new e(t),
        ...
        o = this.output;
      return p5.prototype._mathChain(this, i, n, o, e)
    }, p5.Env.prototype.mult = function(t) {
      var e = new i(t),
        n = this.mathOps.length,
        o = this.output;
      return p5.prototype._mathChain(this, e, n, o, i)
    }, p5.Env.prototype.scale = function(t, e, i, o) {
      var r = new n(t, e, i, o),
        s = this.mathOps.length,
        a = this.output;
      return p5.prototype._mathChain(this, r, s, a, n)
    }, p5.Env.prototype.dispose = function() {
      var e = t.soundArray.indexOf(this);
      t.soundArray.splice(e, 1), this.disconnect();
      try {
  ...
  pulse = function() {
    function t() {
      for (var t = e.audiocontext, i = t.createBuffer(1, 2048, t.sampleRate), n = i.getChannelData(0), o = 0; 2048 > o; o++) n[o] = 1;
      var r = t.createBufferSource();
      return r.buffer = i, r.loop = !0, r
    }
    var e = master;
    p5.Pulse = function(i, n) {
      p5.Oscillator.call(this, i, "sawtooth"), this.w = n || 0, this.osc2 = new p5.SawOsc(i), this.dNode = e.audiocontext.createDelay(), this.dcOffset = t(), this.dcGain = e.audiocontext.createGain(), this.dcOffset.connect(this.dcGain), this.dcGain.connect(this.output), this.f = i || 440;
      var o = this.w / this.oscillator.frequency.value;
      this.dNode.delayTime.value = o, this.dcGain.gain.value = 1.7 * (.5 - this.w), this.osc2.disconnect(), this.osc2.panner.disconnect(), this.osc2.amp(-1), this.osc2.output.connect(this.dNode), this.dNode.connect(this.output), this.output.gain.value = 1, this.output.connect(this.panner)
      ...
      if ("number" == typeof t) {
        ...
        this.oscillator.frequency.cancelScheduledValues(o), this.oscillator.frequency.setValueAtTime(r, o + n), this.oscillator.frequency.exponentialRampToValueAtTime(t, n + i + o), this.osc2.oscillator.frequency.cancelScheduledValues(o), this.osc2.oscillator.frequency.setValueAtTime(r, o + n), this.osc2.oscillator.frequency.exponentialRampToValueAtTime(t, n + i + o), this.freqMod && (this.freqMod.output.disconnect(), this.freqMod = null)
  ...
  noise = function() {
    ...
    p5.Noise = function(t) {
      var o;
      p5.Oscillator.call(this), delete this.f, delete this.freq, delete this.oscillator, o = "brown" === t ? n : "pink" === t ? i : e, this.buffer = o
    }, p5.Noise.prototype = Object.create(p5.Oscillator.prototype);
    var e = function() {
        for (var e = 2 * t.audiocontext.sampleRate, i = t.audiocontext.createBuffer(1, e, t.audiocontext.sampleRate), n = i.getChannelData(0), o = 0; e > o; o++) n[o] = 2 * Math.random() - 1;
        return i.type = "white", i
      }(),
      i = function() {
        var e, i, n, o, r, s, a, u = 2 * t.audiocontext.sampleRate,
          p = t.audiocontext.createBuffer(1, u, t.audiocontext.sampleRate),
          c = p.getChannelData(0);
        e = i = n = o = r = s = a = 0;
        for (var h = 0; u > h; h++) {
          var l = 2 * Math.random() - 1;
          e = .99886 * e + .0555179 * l, i = .99332 * i + .0750759 * l, n = .969 * n + .153852 * l, o = .8665 * o + .3104856 * l, r = .55 * r + .5329522 * l, s = -.7616 * s - .016898 * l, c[h] = e + i + n + o + r + s + a + .5362 * l, c[h] *= .11, a = .115926 * l
        }
        return p.type = "pink", p
      }(),
      n = function() {
        for (var e = 2 * t.audiocontext.sampleRate, i = t.audiocontext.createBuffer(1, e, t.audiocontext.sampleRate), n = i.getChannelData(0), o = 0, r = 0; e > r; r++) {
          var s = 2 * Math.random() - 1;
          n[r] = (o + .02 * s) / 1.02, o = n[r], n[r] *= 3.5
        }
        return i.type = "brown", i
      }();
    p5.Noise.prototype.setType = function(o) {
      switch (o) {
        case "white":
          this.buffer = e;
          break;
    ...
    p5.AudioIn = function(e) {
      ...
      if (t.inputSources[n.currentSource]) {
        ...
        window.navigator.getUserMedia(r, this._onStream = function(i) {
          n.stream = i, n.enabled = !0, n.mediaStream = t.audiocontext.createMediaStreamSource(i), n.mediaStream.connect(n.output), e && e(), n.amplitude.setInput(n.output)
        ...
        n.stream = i, n.enabled = !0, n.mediaStream = t.audiocontext.createMediaStreamSource(i), n.mediaStream.connect(n.output), n.amplitude.setInput(n.output), e && e()
      }, this._onStreamError = function(t) {
        i ? i(t) : console.error(t)
      })
      ...
      if (i) {
        ...
        this.output.gain.cancelScheduledValues(t.audiocontext.currentTime), this.output.gain.setValueAtTime(o, t.audiocontext.currentTime), this.output.gain.linearRampToValueAtTime(e, n + t.audiocontext.currentTime)
  ...
  Tone_signal_Subtract = function(t) {
    "use strict";
  ...
  Tone_signal_GreaterThanZero = function(t) {
    "use strict";
  ...
  Tone_signal_EqualZero = function(t) {
    "use strict";
  ...
  Tone_signal_Select = function(t) {
    "use strict";
    t.Select = function(i) {
      i = this.defaultArg(i, 2), t.call(this, i, 1), this.gate = new t.Signal(0), this._readOnly("gate");
      for (var n = 0; i > n; n++) {
        var o = new e(n);
        this.input[n] = o, this.gate.connect(o.selecter), o.connect(this.output)
      }
  ...
  Tone_signal_IfThenElse = function(t) {
    "use strict";
  ...
  var Tone_signal_NOT;
  Tone_signal_NOT = function(t) {
    "use strict";
    return t.NOT = t.EqualZero, t.NOT
  }(Tone_core_Tone);
  var Tone_signal_GreaterThan;
  Tone_signal_GreaterThan = function(t) {
    "use strict";
  ...
  Tone_signal_LessThan = function(t) {
    "use strict";
  ...
  Tone_signal_AudioToGain = function(t) {
    "use strict";
  ...
  Tone_signal_Expr = function(t) {
    ...
    return t.Expr = function() {
      ...
      try {
        ...
        throw this._disposeNodes(), new Error("Could evaluate expression: " + t)
      }
      this.output = n
      ...
      func: {
        ...
        "if": {
          regexp: /^if/,
          method: function(e, i) {
            var n = new t.IfThenElse;
            return i._eval(e[0]).connect(n["if"]), i._eval(e[1]).connect(n.then), i._eval(e[2]).connect(n["else"]), n
          }
        },
        gt0: {
          regexp: /^gt0/,
      ...
      function o(t) {
        ...
        var e;
        e = 0 > t ? r() : o(t - 1);
        for (var i = p.peek(); n(i, "binary", t);) i = p.next(), e = {
          operator: i.value,
          method: i.method,
          args: [e, o(t)]
        }, i = p.peek();
      ...
      function r() {
        var t, e;
        return t = p.peek(), n(t, "unary") ? (t = p.next(), e = r(), {
          operator: t.value,
          method: t.method,
          args: [e]
        }) : s()
      ...
      function s() {
        var t, e;
        if (t = p.peek(), c(t)) throw new SyntaxError("Unexpected termination of expression");
        if ("func" === t.type) return t = p.next(), a(t);
        if ("value" === t.type) return t = p.next(), {
          method: t.method,
          args: t.value
        };
        if (i(t, "(")) {
          if (p.next(), e = o(), t = p.next(), !i(t, ")")) throw new SyntaxError("Expected )");
          return e
        }
      ...
      function a(t) {
        var e, n = [];
        if (e = p.next(), !i(e, "(")) throw new SyntaxError('Expected ( in a function call "' + t.value + '"');
        if (e = p.peek(), i(e, ")") || (n = u()), e = p.next(), !i(e, ")")) throw new SyntaxError('Expected ) in a function call "' + t.value + '"');
        return {
          method: t.method,
          args: n,
          name: name
      ...
      function u() {
        for (var t, e, n = [];;) {
          if (e = o(), c(e)) break;
          if (n.push(e), t = p.peek(), !i(t, ",")) break;
          p.next()
        }
        return n
      }
      var p = this._tokenize(e),
        c = this.isUndef.bind(this);
      return o()
  ...
  Tone_signal_EqualPowerGain = function(t) {
    "use strict";
  ...
  Tone_component_CrossFade = function(t) {
    "use strict";
  ...
  effect = function() {
    var t = master,
      e = Tone_component_CrossFade;
    return p5.Effect = function() {
      this.ac = t.audiocontext, this.input = this.ac.createGain(), this.output = this.ac.createGain(), this._drywet = new e(1), this.wet = this.ac.createGain(), this.input.connect(this._drywet.a), this.wet.connect(this._drywet.b), this._drywet.connect(this.output), this.connect(), t.soundArray.push(this)
    }, p5.Effect.prototype.amp = function(e, i, n) {
      var i = i || 0,
        n = n || 0,
        o = t.audiocontext.currentTime,
        r = this.output.gain.value;
      this.output.gain.cancelScheduledValues(o), this.output.gain.linearRampToValueAtTime(r, o + n + .001), this.output.gain.linearRampToValueAtTime(e, o + n + i + .001)
      ...
      var e = t.soundArray.indexOf(this);
      t.soundArray.splice(e, 1), this.input.disconnect(), this.input = void 0, this.output.disconnect(), this.output = void 0, this._drywet.disconnect(), delete this._drywet, this.wet.disconnect(), delete this.wet, this.ac = void 0
    }, p5.Effect
  }(master, Tone_component_CrossFade);
  var filter;
  filter = function() {
    var t = effect;
    return p5.Filter = function(e) {
      t.call(this), this.biquad = this.ac.createBiquadFilter(), this.input.connect(this.biquad), this.biquad.connect(this.wet), e && this.setType(e)
    }, p5.Filter.prototype = Object.create(t.prototype), p5.Filter.prototype.process = function(t, e, i, n) {
      ...
      t.prototype.dispose.apply(this), this.biquad.disconnect(), this.biquad = void 0
    }, p5.LowPass = function() {
  ...
  delay = function() {
    var t = filter,
      e = effect;
    p5.Delay = function() {
      e.call(this), this._split = this.ac.createChannelSplitter(2), this._merge = this.ac.createChannelMerger(2), this._leftGain = this.ac.createGain(), this._rightGain = this.ac.createGain(), this.leftDelay = this.ac.createDelay(), this.rightDelay = this.ac.createDelay(), this._leftFilter = new t, this._rightFilter = new t, this._leftFilter.disconnect(), this._rightFilter.disconnect(), this._leftFilter.biquad.frequency.setValueAtTime(1200, this.ac.currentTime), this._rightFilter.biquad.frequency.setValueAtTime(1200, this.ac.currentTime), this._leftFilter.biquad.Q.setValueAtTime(.3, this.ac.currentTime), this._rightFilter.biquad.Q.setValueAtTime(.3, this.ac.currentTime), this.input.connect(this._split), this.leftDelay.connect(this._leftGain), this.rightDelay.connect(this._rightGain), this._leftGain.connect(this._leftFilter.input), this._rightGain.connect(this._rightFilter.input), this._merge.connect(this.wet), this._leftFilter.biquad.gain.setValueAtTime(1, this.ac.currentTime), this._rightFilter.biquad.gain.setValueAtTime(1, this.ac.currentTime), this.setType(0), this._maxDelay = this.leftDelay.delayTime.maxValue, this.feedback(.5)
    }, p5.Delay.prototype = Object.create(e.prototype), p5.Delay.prototype.process = function(t, e, i, n) {
      var o = i || 0,
        r = e || 0;
      ...
      e.prototype.dispose.apply(this), this._split.disconnect(), this._leftFilter.dispose(), this._rightFilter.dispose(), this._merge.disconnect(), this._leftGain.disconnect(), this._rightGain.disconnect(), this.leftDelay.disconnect(), this.rightDelay.disconnect(), this._split = void 0, this._leftFilter = void 0, this._rightFilter = void 0, this._merge = void 0, this._leftGain = void 0, this._rightGain = void 0, this.leftDelay = void 0, this.rightDelay = void 0
    }
  }(filter, effect);
  var reverb;
  reverb = function() {
    var t = errorHandler,
      e = effect;
    p5.Reverb = function() {
      e.call(this), this.convolverNode = this.ac.createConvolver(), this.input.gain.value = .5, this.input.connect(this.convolverNode), this.convolverNode.connect(this.wet), this._seconds = 3, this._decay = 2, this._reverse = !1, this._buildImpulse()
    }, p5.Reverb.prototype = Object.create(e.prototype), p5.Reverb.prototype.process = function(t, e, i, n) {
      ...
      e.prototype.dispose.apply(this), this.convolverNode && (this.convolverNode.buffer = null, this.convolverNode = null)
    }, p5.Convolver = function(t, i, n) {
      e.call(this), this.convolverNode = this.ac.createConvolver(), this.input.gain.value = .5, this.input.connect(this.convolverNode), this.convolverNode.connect(this.wet), t ? (this.impulses = [], this._loadBuffer(t, i, n)) : (this._seconds = 3, this._decay = 2, this._reverse = !1, this._buildImpulse())
      ...
      var n = new p5.Convolver(t, e, i);
      return n.impulses = [], n
    }, p5.Convolver.prototype._loadBuffer = function(e, i, n) {
      var e = p5.prototype._checkFileFormats(e),
        o = this,
        r = (new Error).stack,
        s = p5.prototype.getAudioContext(),
        a = new XMLHttpRequest;
      a.open("GET", e, !0), a.responseType = "arraybuffer", a.onload = function() {
        if (200 === a.status) s.decodeAudioData(a.response, function(t) {
          var n = {},
            r = e.split("/");
          n.name = r[r.length - 1], n.audioBuffer = t, o.impulses.push(n), o.convolverNode.buffer = n.audioBuffer, i && i(n)
        }, function() {
          var e = new t("decodeAudioData", r, o.url),
            i = "AudioContext error at decodeAudioData for " + o.url;
          n ? (e.msg = i, n(e)) : console.error(i + "\n The error stack trace includes: \n" + e.stack)
        });
        else {
          var u = new t("loadConvolver", r, o.url),
            p = "Unable to load " + o.url + ". The request status was: " + a.status + " (" + a.statusText + ")";
          n ? (u.message = p, n(u)) : console.error(p + "\n The error stack trace includes: \n" + u.stack)
        }
      }, a.onerror = function() {
        var e = new t("loadConvolver", r, o.url),
          i = "There was no response from the server at " + o.url + ". Check the url and internet connectivity.";
        n ? (e.message = i, n(e)) : console.error(i + "\n The error stack trace includes: \n" + e.stack)
      }, a.send()
  ...
  Tone_core_Clock = function(t) {
    ...
    return t.Clock = function() {
      ...
      var n = this.now(),
        o = 2 * this._computedLookAhead,
        r = this._state.getEvent(n + o),
        s = t.State.Stopped;
  ...
  metro = function() {
    ...
    p5.Metro = function() {
      ...
      var i = e - this.prevTick,
        n = e - t.audiocontext.currentTime;
      ...
      this.tatumTime = n;
      var i = i || 0;
      this.clock.frequency.setValueAtTime(this.clock.frequency.value, o), this.clock.frequency.linearRampToValueAtTime(e, o + i), this.bpm = e
  ...
  looper = function() {
    ...
    p5.prototype.setBPM = function(t, n) {
      i = t;
      for (var o in e.parts) e.parts[o] && e.parts[o].setBPM(t, n)
    }, p5.Phrase = function(t, e, i) {
      this.phraseStep = 0, this.name = t, this.callback = e, this.sequence = i
    }, p5.Part = function(t, n) {
      this.length = t || 0, this.partStep = 0, this.phrases = [], this.isPlaying = !1, this.noLoop(), this.tatums = n || .0625, this.metro = new p5.Metro, this.metro._init(), this.metro.beatLength(this.tatums), this.metro.setBPM(i), e.parts.push(this), this.callback = function() {}
      ...
      var n;
      if (3 === arguments.length) n = new p5.Phrase(t, e, i);
      else {
        if (!(arguments[0] instanceof p5.Phrase)) throw "invalid input. addPhrase accepts name, callback, array or a p5.Phrase";
        n = arguments[0]
      }
      this.phrases.push(n), n.sequence.length > this.length && (this.length = n.sequence.length)
  ...
  compressor = function() {
    ...
    return p5.Compressor = function() {
      t.call(this), this.compressor = this.ac.createDynamicsCompressor(), this.input.connect(this.compressor), this.compressor.connect(this.wet)
    }, p5.Compressor.prototype = Object.create(t.prototype), p5.Compressor.prototype.process = function(t, e, i, n, o, r) {
      t.connect(this.input), this.set(e, i, n, o, r)
    }, p5.Compressor.prototype.set = function(t, e, i, n, o) {
      ...
      t.prototype.dispose.apply(this), this.compressor.disconnect(), this.compressor = void 0
    }, p5.Compressor
  ...
  soundRecorder = function() {
    ...
    p5.SoundRecorder = function() {
      ...
      this.input.disconnect(), this.input = null, this.input = n.createGain(), this.input.connect(this._jsNode), this.input.connect(this.output), t ? t.connect(this.input) : p5.soundOut.output.connect(this.input)
    ...
    }, p5.prototype.saveSound = function(i, n) {
      var o, r;
      o = i.buffer.getChannelData(0), r = i.buffer.numberOfChannels > 1 ? i.buffer.getChannelData(1) : o;
      var s = t(o, r),
      ...
      for (var p = s.length, c = 44, h = 1, l = 0; p > l; l++) u.setInt16(c, s[l] * (32767 * h), !0), c += 2;
      p5.prototype.writeFile([u], n, "wav")
    }
  }(sndcore, master);
  var peakdetect;
  peakdetect = function() {
    p5.PeakDetect = function(t, e, i, n) {
  ...
  gain = function() {
    ...
    p5.Gain = function() {
      ...
      this.output.disconnect()
    }, p5.Gain.prototype.amp = function(e, i, n) {
      var i = i || 0,
        n = n || 0,
        o = t.audiocontext.currentTime,
        r = this.output.gain.value;
      this.output.gain.cancelScheduledValues(o), this.output.gain.linearRampToValueAtTime(r, o + n), this.output.gain.linearRampToValueAtTime(e, o + n + i)
  ...
  distortion = function() {
    ...
    var e = effect;
    p5.Distortion = function(i, n) {
      if (e.call(this), "undefined" == typeof i && (i = .25), "number" != typeof i) throw new Error("amount must be a number");
      if ("undefined" == typeof n && (n = "2x"), "string" != typeof n) throw new Error("oversample must be a String");
      var o = p5.prototype.map(i, 0, 1, 0, 2e3);
      this.waveShaperNode = this.ac.createWaveShaper(), this.amount = o, this.waveShaperNode.curve = t(o), this.waveShaperNode.oversample = n, this.input.connect(this.waveShaperNode), this.waveShaperNode.connect(this.wet)
    }, p5.Distortion.prototype = Object.create(e.prototype), p5.Distortion.prototype.process = function(t, e, i) {
      t.connect(this.input), this.set(e, i)
    }, p5.Distortion.prototype.set = function(e, i) {
      if (e) {
        var n = p5.prototype.map(e, 0, 1, 0, 2e3);
        this.amount = n, this.waveShaperNode.curve = t(n)
      }
      ...
      e.prototype.dispose.apply(this), this.waveShaperNode.disconnect(), this.waveShaperNode = null
    }
  }(effect);
  var src_app;
  src_app = function() {
